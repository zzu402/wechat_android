...
@SuppressLint({ "HandlerLeak", "InflateParams" }) public class FloatingView extends FrameLayout implements AutoService.AutoObserver {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == AutoService.SHOWINFO) {
                mInfoText.setText((String) msg.obj);
            }
        }
    };

    public FloatingView(AutoService service) {
        super(service);
        mService = service;
...
//                    mParams.y += mTouchStartY - (int) event.getRawY();//相对于屏幕右下角的位置
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (view == mImageStart) {
                        ...
                        hide();
                        Intent intent = new Intent(mService, AutoService.class);
