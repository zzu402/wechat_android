...
public class StringUtil {
    ...
    @SuppressLint("DefaultLocale") public static String hexTimeStr(){
     ...
     * @return
     */
    @SuppressLint("DefaultLocale") public static String getWanMoney(long money) {
     ...
     * @return
     */
    @SuppressLint("DefaultLocale") public static String getYuanMoney(long money) {
